...
let centerPoints = [
  [-1.257368028466541028848, 0.378730831028625370052, 4e12],
  [-1.985540371654130485531, 0.0, 4e12],
  [-1.778103342740640371105, 0.007673942421213393926726719, 1e11],
  [-1.428683445072090832353, 0.162497141672790506229031, 4e13],
  [-1.749721929742338571710, -0.000029016647753687627476, 4e11],
  [-1.296354375872896773478, 0.4418515556622909852670589, 5e11],
  [0.0, 1.0, 2.0]
];
let centerOffsetX64 = centerPoints[pointIndex][0];
let centerOffsetY64 = centerPoints[pointIndex][1];
let zoom64 = 1;
const zoomThreshold64 = centerPoints[pointIndex][2];
