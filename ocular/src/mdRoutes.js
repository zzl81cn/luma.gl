      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            onUpdate: () => {
              setPathPrefix(`${RAW_GITHUB}/examples/lessons/05/`)
            },
          },
          {
            ...
            onUpdate: () => {
              setPathPrefix(`${RAW_GITHUB}/examples/lessons/06/`)
            },
          },
          {
            ...
            onUpdate: () => {
              setPathPrefix(`${RAW_GITHUB}/examples/lessons/07/`)
            },
          },
          {
            ...
            onUpdate: () => {
              setPathPrefix(`${RAW_GITHUB}/examples/lessons/08/`)
            },
          },
          {
            ...
            onUpdate: () => {
              setPathPrefix(`${RAW_GITHUB}/examples/lessons/09/`)
            },
          },
          {
            name: 'Lesson 10',
            ...
            onUpdate: () => {
              setPathPrefix(`${RAW_GITHUB}/examples/lessons/10/`)
            },
          },
          {
            name: 'Lesson 11',
            ...
            onUpdate: () => {
              setPathPrefix(`${RAW_GITHUB}/examples/lessons/11/`)
            },
          },
          // {
          //   name: 'Lesson 12',
          ...
          // component: 'Lesson15
          {
            ...
            onUpdate: () => {
              setPathPrefix(`${RAW_GITHUB}/examples/lessons/16/`)
            },
          },
        ],
      },
