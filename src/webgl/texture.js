...
import GL, {WebGL2RenderingContext, WebGLBuffer} from './api';
...
export default class Texture extends Resource {
  ...
  constructor(gl, {
    ...
    // this.initialize(opts); - initialize must be called by subclasses
  }
  ...
  initialize({
    ...
    context.withParameters(this.gl, opts, () => {
      this._setImage({data, width, height, format, type, dataFormat, border, mipmaps});
  ...
  generateMipmap(params = {}) {
    ...
    context.withParameter(this.gl, params, () => {
  ...
  getParameter(pname) {
    // TODO - handle WebGL2 parameters
    switch (pname) {
    case GL.TEXTURE_WRAP_R: return 0;
    case GL.TEXTURE_BASE_LEVEL: return 0;
    case GL.TEXTURE_MAX_LEVEL: return 0;
    case GL.TEXTURE_COMPARE_FUNC: return 0;
    case GL.TEXTURE_COMPARE_MODE: return 0;
    case GL.TEXTURE_MIN_LOD: return 0;
    case GL.TEXTURE_MAX_LOD: return 0;
    default:
    }
